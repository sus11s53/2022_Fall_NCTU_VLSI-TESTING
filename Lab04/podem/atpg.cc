...
void CIRCUIT::GenerateAllCPSAaultList()
{
    ...
    cout << "" << endl;
    cout << "Generate all fault list " << endl;
    cout << "" << endl;
    ...
    cout << "" << endl;
    cout << "Generate checkpoint theorem fault list " << endl;
    cout << "" << endl;
    for (auto it = CPlist.rbegin(); it != CPlist.rend(); it++)
    {
        cout << (*it)->GetInputGate()->GetName() << " " << (*it)->GetOutputGate()->GetName() << " " << (*it)->GetValue() << endl;
        CPcounter = CPcounter + 1;
    }
    cout << "" << endl;
    cout << "Number of faults = " << counter << endl;
    cout << "Number of checkpoint faults = " << CPcounter << endl;
    collapsed = counter - CPcounter;
    percentage = (collapsed / counter) * 100;
    cout << "percentage of faults have been collapsed = " << fixed << setprecision(2) << percentage << " % " << endl;
