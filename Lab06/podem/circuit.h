...
private:
    ...
    list<FAULT *> CPlist;    // checkpoint fault list
    vector<FAULT *> BTFlist; // bridging fault convert to stuck at fault list
    vector<FAULT *> BTF2list;
    set<string> Dlist;
...
public:
    ...
    //******************************//
    void GenerateAllCpFaultList(); // atpg.cc
    void GenerateBridgingFaults(); //(string a) // bridging.cc
    void GenerateGoalFaultList();
    void BridgingFaultCov();
